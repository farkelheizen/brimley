...
class BrimleyProvider:
    """Provider-first integration surface for exposing Brimley functions via FastMCP."""

    def __init__(self, registry: Registry[BrimleyFunction], context: BrimleyContext):
        """Initialize provider with function registry and runtime context."""
...
"""
    ...
    def register_tools(self, mcp_server: Any = None) -> Any:
        ...
        if mcp_server is None:
            fastmcp_cls = self.require_fastmcp()
            mcp_server = fastmcp_cls(name="BrimleyTools")
